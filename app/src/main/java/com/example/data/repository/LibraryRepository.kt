...
class LibraryRepository(
    ...
    suspend fun fetchAndSaveOrot() {
        withContext(Dispatchers.IO) {
            try {
                ...
                if (chapterCount >= EXPECTED_CHAPTERS && paragraphCount >= EXPECTED_PARAGRAPHS) {
    ...
    companion object {
        // Contents of assets/orot_data.json, generated by scripts/build_orot_data.py.
        private const val EXPECTED_CHAPTERS = 28
        private const val EXPECTED_PARAGRAPHS = 343
    }
}
